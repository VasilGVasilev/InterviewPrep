...
2.  ### What are the major features of React?
    ...
    - Follows **Unidirectional or one-way** data flow or data binding. - child components are not able to update the data that is coming from the parent component, only via callbacks
