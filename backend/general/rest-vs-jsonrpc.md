...
**JSON-RPC** is a remote procedure call (RPC) protocol encoded in JSON. **It's designed to invoke methods (functions) on a server rather than operate on resources.**
